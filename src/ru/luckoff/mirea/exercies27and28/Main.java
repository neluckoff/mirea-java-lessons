package ru.luckoff.mirea.exercies27and28;
...
public class Main implements Runnable {
    ...
    private void resize(int i) {
        int cores =Runtime.getRuntime().availableProcessors();
        String srcFolder = "src/ru/luckoff/mirea/exercies27and28/images";
        String dstFolder = "src/ru/luckoff/mirea/exercies27and28/new_images";
